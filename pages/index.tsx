    ...
    <div className="h-full bg-green-900 py-10 px-10 md:px-24 text-white overflow-y-hidden">
      ...
      <div className="md:space-x-4 text-center">
        <div className="my-12 md:w-2/3 mx-auto text-start md:text-center">
          ...
          <div className="inline-block border-1px border-green-100 max-w-[289px] p-3.5 mb-5">
            ...
            <div className="relative md:static mt-20 md:mt-0">
              ...
              <SplideTrack className="md:mt-20">
                <SplideSlide className="max-w-max cursor-pointer">
                  <div className="flex ml-5 justify-between items-center max-w-[400px] p-5 border-1px border-green-100 rounded-xl">
